	...
	<script type="text/javascript">
		$(function () {
			$("button.addToCart").click(function () {
				...
				/*location.href="http://localhost:8089/book/cartServlet?action=addItem&id="+bookId;*/
				$.getJSON("http://localhost:8089/book/cartServlet","action=ajaxAddItem&id="+bookId,function (data) {
