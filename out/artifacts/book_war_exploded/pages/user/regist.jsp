						...
						<div class="login_box">
							...
							<div class="form">
								<form action="userServlet" method="post">
									...
									<br />
									<label>验证码：</label>
									<input class="itxt" type="text" style="width: 110px;height: 15px" name="code" id="code"
										   value="${requestScope.code}"/>
									<img id="kaptcha" alt="" src="kaptchaServlet" style="float: right; margin-right: 40px;width: 100px;height: 45px">
									<br />
									<br />
